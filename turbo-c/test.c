/*
	...
	Turbo C(v2) version of the cpu-emulator.

	Some minor changes compared to the C-only version, just to get it to compile
	under MS-DOS.
...
/* Sorry, for MS-DOS int32_t will be replaced with a short (16-bit) */
...
#define OPCODESIZE (unsigned long) 2
